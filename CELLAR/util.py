...
# from THS                import authority
# from THS.models         import UserInfo
# from THS.util_index     import DESCRIPTOR
# 
# class THSFileManager(FileManager):
#     """
#     THS 에서 사용할 파일 메니져.
...
#     manager = THSFileManager(request)
